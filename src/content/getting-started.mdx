...
```html
<div class="picobel picobel--index-0" data-picobel-index="0">
...
```html
<div class="picobel picobel--index-0 default" data-picobel-index="0">
    <div class="default__loader"></div>
    
    <button class="default__play-pause" type="button">
        <span class="default__play-pause__text">Play</span>
    </button>
    
    <div class="default__wrapper--title-artist">
        <span class="default__title">Taken at the Flood</span>
        <span class="default__artist">Freeze Them</span>
    </div>
</div>
```
...
const areaToSearch = document.querySelector("#example-01");

picobel({ context: areaToSearch})
```
